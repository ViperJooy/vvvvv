...
import com.viper.vvvvv.widget.BiliDanmukuParser;
...
//                    Log.d("DFM", "danmakuShown(): text=" + danmaku.text);
        ...
        if (mVideoView != null) {
            ...
            mVideoView.setVideoPath(Environment.getExternalStorageDirectory() + "/视频/11-25-18.mp4");
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.danmu_main, menu);
        return true;
    }
